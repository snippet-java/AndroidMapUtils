...
public class GeoJsonDemoActivity extends BaseDemoActivity {
    ...
    private void retrieveFileFromResource() {
        try {
            GeoJsonLayer layer = new GeoJsonLayer(getMap(), R.raw.initialdata, this);
    ...
    private void addColorsToMarkers(GeoJsonLayer layer) {
        ...
        for (GeoJsonFeature feature : layer.getFeatures()) {
            ...
            if (feature.getProperty("title") != null && feature.hasProperty("place")) {
                String magnitude = (feature.getProperty("title"));
                ...
                pointStyle.setTitle("Owned by " + magnitude);
                pointStyle.setSnippet("Device ID " + feature.getProperty("magnitude"));
